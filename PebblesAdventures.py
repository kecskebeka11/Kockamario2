...
slingy_sheet = pygame.image.load("slingy_sam.png").convert_alpha()
...
class SlingySam:
    def __init__(self,platform,seb=2):
        ...
        self.rect=pygame.Rect(platform.left,platform.top-32,48,32)
        self.seb=seb
        self.frame=0
        self.anim_timer=0
        self.facing_left=False
        self.frames=[slingy_sheet.subsurface((0,0,48,32)),slingy_sheet.subsurface((48,0,48,32))]
    def update(self):
        self.anim_timer+=1
        if self.anim_timer>=15:
            self.frame=(self.frame+1)%2
    ...
    def rajzol(self,felulet,kamera_x):
        sprite=self.frames[self.frame]
        if self.facing_left: sprite=pygame.transform.flip(sprite,True,False)
        sprite=pygame.transform.scale(sprite,(48,32))
        felulet.blit(sprite,(self.rect.x-kamera_x,self.rect.y))
...
def palya_betoltes(szint):
    ...
    enemyk_vegleges = []
    if szint==1:
        platformok=[pygame.Rect(0,550,1000,50),pygame.Rect(1100,550,1000,50),
                    pygame.Rect(400,450,150,20),pygame.Rect(700,350,150,20),
                    pygame.Rect(1300,400,200,20),pygame.Rect(1600,250,100,20)]
        ermek=[pygame.Rect(450,410,20,20),pygame.Rect(750,310,20,20),
               pygame.Rect(1350,360,20,20),pygame.Rect(1640,210,20,20)]
        enemyk=[Enemy(600,500),Enemy(1400,300),Enemy(1600,210),Enemy(1100,500)]
        enemyk_vegleges = [SlingySam(platformok[3],seb=3)]
        celkapu=pygame.Rect(1900,450,50,100)
        kezdo_pos=(50,450)
    elif szint==2:
        platformok=[pygame.Rect(0,550,400,50),pygame.Rect(500,450,100,20),
                    pygame.Rect(700,350,100,20),pygame.Rect(900,250,100,20),
                    pygame.Rect(1100,400,300,20),pygame.Rect(1500,550,500,50),
                    pygame.Rect(1800,450,100,20),pygame.Rect(2100,300,300,20)]
        ermek=[pygame.Rect(540,410,20,20),pygame.Rect(740,310,20,20),
               pygame.Rect(940,210,20,20),pygame.Rect(1200,360,20,20),
        ...
        platformok=[pygame.Rect(0,550,400,50),pygame.Rect(500,450,20,20),
                    pygame.Rect(700,350,5,20),pygame.Rect(900,250,20,20),
                    pygame.Rect(1100,400,300,20),pygame.Rect(1500,550,500,50),
                    pygame.Rect(1800,450,100,20),pygame.Rect(2100,300,300,20)]
        ermek=[pygame.Rect(510,410,20,20),pygame.Rect(699,345,20,20),
               pygame.Rect(910,200,20,20),pygame.Rect(1200,300,20,20),
               pygame.Rect(2200,260,20,20)]
        enemyk=[Enemy(600,300)]
        ...
        enemyk_vegleges = [SlingySam(platformok[4],seb=3),  SlingySam(platformok[5],seb=3),SlingySam(platformok[10],seb=3)]
        ...
        celkapu = pygame.Rect(3250, 450, 50, 100)
        kezdo_pos = (50, 450)
    
    eredeti_ermek=[pygame.Rect(e.x,e.y,e.width,e.height) for e in ermek]
    return platformok,ermek,enemyk,enemyk_vegleges,celkapu,kezdo_pos,eredeti_ermek
...
platformok,ermek,enemyk,enemyk_vegleges,celkapu,kezdo_pos,eredeti_ermek=palya_betoltes(aktualis_palya)
...
while futo:
    ...
    if not jatek_vege:
        ...
        if mario.rect.top>MAGASSAG:
            ...
            platformok,_,enemyk,enemyk_vegleges,_,_,_ = palya_betoltes(aktualis_palya)
